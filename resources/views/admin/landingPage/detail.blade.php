                            ...
                            <div class="order-details">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="d-flex mb-3">
                                        ...
                                        <div>Putu Anggaeni 88 | +6281239239108 | emailcustomer@email.com</div>
                                    </li>
                                    <li class="d-flex mb-3">
                                        <div class="fw-medium" style="width: 180px;">
                                    ...
                                    <li class="d-flex mb-3">
                                        ...
                                        <div>GELANG TASBIH 33 BUTIR</div>
                                    </li>
                                    <li class="d-flex mb-3">
                                        <div class="fw-medium" style="width: 180px;">
                                            <i class="bx bx-circle me-2" style="font-size: 8px; vertical-align: middle;"></i>Variasi
                                        </div>
                                        <div>Produk: Gelang Tasbih 33 butir = 145.000, Warna: Pink (x1)</div>
                                    </li>
                                    <li class="d-flex mb-3">
                                        <div class="fw-medium" style="width: 180px;">
                                    ...
                                    <li class="d-flex mb-3">
                                        ...
                                        <div><span class="badge bg-danger">Unpaid</span></div>
                                    </li>
                                    <li class="d-flex mb-3">
                                        <div class="fw-medium" style="width: 180px;">
