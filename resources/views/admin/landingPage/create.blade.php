            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-20 fw-bold">Tambah Landing Page</h4>
                    </div>
                </div>
            </div>
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="name" required oninput="generate_slug(this.value)">
                                    </div>
                                </div>
                                <div class="mb-2">
                                    <label class="form-label fw-bold">Slug Landing Page</label>
                                    <input type="text" class="form-control" name="slug" required id="slug" readonly placeholder="This slug value will automatically generated">
                                </div>
                                <h4 class="fw-bold mt-4 section">Section 1</h4>
                                <div class="mb-2">
                                    <label class="form-label fw-bold">Judul Section 1</label>
                                    <textarea type="text" class="form-control" name="section_1_title" id="editor" ></textarea>
                                </div>
                                <div class="mb-2">
                                    <label class="form-label fw-bold">Upload Gambar Section 1</label>
                                    <input type="file" class="form-control" name="section_1_media" accept="image/*" required>
                                </div>
                                <div class="mb-2">
                                    <label class="form-label fw-bold">Keterangan Section 1</label>
                                    <textarea class="form-control" id="editor" name="section_1_description"></textarea>
                                </div>
                                <div class="mb-2">
                                    <label class="form-label fw-bold">Background Section 1</label>
                                    <input type="color" class="form-control" name="section_1_bg" required>
                                </div>
                                <h4 class="fw-bold mt-4 section">Section 2</h4>
                                <div class="mb-2">
                                    <label class="form-label fw-bold">Judul Section 2</label>
                                    <textarea type="text" class="form-control" name="section_2_title" id="editor"></textarea>
                                </div>
                                <div class="mb-2">
                                    <label class="form-label fw-bold">Upload Gambar Section 2</label>
                                    <input type="file" class="form-control" name="section_2_media" accept="image/*" required>
                                </div>
                                <div class="mb-2">
                                    <label class="form-label fw-bold">Keterangan Section 2</label>
                                    <textarea class="form-control" id="editor" name="section_2_description"></textarea>
                                </div>
                                <div class="mb-2">
                                    <label class="form-label fw-bold">Background Section 2</label>
                                    <input type="color" class="form-control" name="section_2_bg" required>
                                </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea type="text" class="form-control" name="section_3_title" id="editor" ></textarea>
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea class="form-control" id="editor" name="section_3_description"></textarea>
                                </div>
                                <div class="mb-2">
                                    <label class="form-label fw-bold">Background Section 3</label>
                                    <input type="color" class="form-control" name="section_3_bg" required>
                                </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea type="text" class="form-control" name="section_4_title" id="editor" ></textarea>
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea class="form-control" id="editor" name="section_4_description"></textarea>
                                </div>
                                <div class="mb-2">
                                    <label class="form-label fw-bold">Background Section 4</label>
                                    <input type="color" class="form-control" name="section_4_bg" required>
                                </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea type="text" class="form-control" name="section_5_title" id="editor" ></textarea>
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea class="form-control" id="editor" name="section_5_description"></textarea>
                                </div>
                                <div class="mb-2">
                                    <label class="form-label fw-bold">Background Section 5</label>
                                    <input type="color" class="form-control" name="section_5_bg" required>
                                </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea type="text" class="form-control" name="section_6_title" id="editor" ></textarea>
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea class="form-control" id="editor" name="section_6_description"></textarea>
                                </div>
                                <div class="mb-2">
                                    <label class="form-label fw-bold">Background Section 6</label>
                                    <input type="color" class="form-control" name="section_6_bg" required>
                                </div>
