...
<body>
    ...
    <div class="container">
        <header style="background: {{ $landing->section_1_bg  }};">
            <h1>{!! $landing->section_1_title !!}</h1>
            <p class="description">
                {!! $landing->section_1_description !!}
            </p>
        </header>

        <div class="promo-banner" style="background: {{ $landing->section_1_bg  }};">
            <!-- <div class="kuota">Kuota Terbatas</div> -->
            <img src="/storage/{{ $landing->section_1_media }}" alt="Buku Yuk Berpuasa" class="book-cover" style="width: 100%;height: auto;">
        </div>

        <div class="product-info" style="padding: 30px;background: {{ $landing->section_2_bg  }};">
            <div class="product-image">
                <img src="/storage/{{ $landing->section_2_media }}" alt="Produk Seri Ramadhan Pertamaku">
            </div>
            <div class="product-details">
                <h1 class="product-title">{!! $landing->section_2_title !!}</h1>
                <p>
                    {!! $landing->section_2_description !!}
                </p>
                <a href="#order" class="cta-button">Beli Sekarang</a>
            </div>
        </div>

        @if($landing->use_section_3 || $landing->use_section_3 === '1')
        <div class="testimonial" style="background: {{ $landing->section_3_bg  }};border-radius:0;">
            <h1 class="testimonial-heading">{!! $landing->section_3_title !!}</h1>
            <div class="testimonial-content">
                <div class="testimonial-text">
                    {!! $landing->section_3_description !!}
                </div>
                <div class="testimonial-images">
                    <img src="/storage/{{ $landing->section_3_media }}" alt="Buku Seri Ramadhan" class="testimonial-image">
                </div>
            </div>
        </div>
        @endif

        @if($landing->use_section_4 || $landing->use_section_4 === '1')
        <header style="background: {{ $landing->section_4_bg  }};border-radius:0;">
            <h1>{!! $landing->section_4_title !!}</h1>
            <p class="description">
                {!! $landing->section_4_description !!}
            </p>
        </header>

        <div class="promo-banner" style="background: {{ $landing->section_4_bg  }};border-radius:0;">
            <img src="/storage/{{ $landing->section_4_media }}" alt="Buku Yuk Berpuasa" class="book-cover" style="width: 100%;height: auto;">
        </div>
        @endif

        @if($landing->use_section_5 || $landing->use_section_5 === '1')
        <header style="background: {{ $landing->section_5_bg  }};border-radius:0;">
            <h1>{!! $landing->section_5_title !!}</h1>
            <p class="description">
                {!! $landing->section_5_description !!}
            </p>
        </header>

        <div class="promo-banner" style="background: {{ $landing->section_5_bg  }};border-radius:0;">
            <img src="/storage/{{ $landing->section_5_media }}" alt="Buku Yuk Berpuasa" class="book-cover" style="width: 100%;height: auto;">
        </div>
        @endif

        @if($landing->use_section_6 || $landing->use_section_6 === '1')
        <header style="background: {{ $landing->section_6_bg  }};border-radius:0;">
            <h1>{!! $landing->section_6_title !!}</h1>
            <p class="description">
                {!! $landing->section_6_description !!}
            </p>
        </header>

        <div class="promo-banner" style="background: {{ $landing->section_6_bg  }};border-radius:0;">
            <img src="/storage/{{ $landing->section_6_media }}" alt="Buku Yuk Berpuasa" class="book-cover" style="width: 100%;height: auto;">
        </div>
        @endif

        <div class="header-stripe"></div>

        <div style="padding: 30px;" id="order">
    ...
    <div class="footer">
      <p>© 2025 Seri Ramadhan Pertamaku. Semua hak dilindungi.</p>
    </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    Swal.fire({
                        ...
                        location.href = '/orders/'+response.order_id;
                    });
                },
